...
Here's how this would look from the command line:
```{engine='bash', eval=FALSE}
git add myfile
...
Nothing very formal here, but make sure you're able to install a package from CRAN and that you're able to read/write files from an arbitrary directory on your computer's filesystem. Grab one of us if you have any problems.
