B1;2c% R bootcamp, Module 0: Recruit processing
...
The Piazza site ([https://piazza.com/berkeley/summer2014/rbootcamp2014/home](https://piazza.com/berkeley/summer2014/rbootcamp2014/home)) is the main site for the bootcamp. It has information on logistics, software installation, and the Q&A area for online questions.  It also has a link to a zip file with all the workshop materials.

The Github site ([https://github.com/berkeley-scf/r-bootcamp-2014](https://github.com/berkeley-scf/r-bootcamp-2014)) is updated more frequently (sometimes in real time) and is the master repository for materials for the modules; you can also get the individual files from Github. Instructions for accessing the materials on Github are on the Piazza site.
...
* Username:	guest-256415 Password:	AnFshjc3N5
* Username:	guest-256416 Password:	5G2W5sDoo6
* Username:	guest-256417 Password:	QrMerb3Mud
* Username:	guest-256418 Password:	Qt2Ozbuslv
* Username:	guest-256419 Password:	XEO42kAi5u
* Username:	guest-256420 Password:	tZZgrvA4Dq
* Username:	guest-256421 Password:	ubrHNVqEA8
* Username:	guest-256422 Password:	j4GYuWKr2g
...
Counselors will be available to help answer any questions you have (just wave to one of them), or feel free to just ask the presenter during the presentation. The counselors will also be monitoring the [Piazza Q&A area](https://piazza.com/berkeley/summer2014/rbootcamp2014/home), so feel free to type in a question there and one of the counselors will answer the question. Or if you know the answer, help us out by answering it yourself or adding your thoughts. 

Your counseloRs are: Gabriela, Chris K., and Jarrod.
...
- "Repository URL": https://github.com/berkeley-scf/r-bootcamp-2014
- "Project Directory Name": r-bootcamp-2014 (or something else of your choosing)
...
- `git clone https://github.com/berkeley-scf/r-bootcamp-2014`

Then to update from the repository to get any changes we've made:

- `cd /directory/where/you/put/the/repository/r-bootcamp-2014`
- `git pull`
