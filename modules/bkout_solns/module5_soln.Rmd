...
```{r}
predict(mod1, newdata = data.frame(income = "$75,000-$99,999", sex = 'female', 
race = 'white'), type = 'response')
predict(mod1, newdata = data.frame(income = "$15,000-$29,999", sex = 'female', 
race = 'white'), type = 'response')
predict(mod1, newdata = data.frame(income = "$75,000-$99,999", sex = 'female', 
race = 'black'), type = 'response')
```
...
vote_white <- vote_white[vote_white$pres04 == 1 | vote_white$pres04 == 2, ]
vote_white$pres04[vote_white$pres04 == 2] <- 0 # 0=bush; 1=kerry
