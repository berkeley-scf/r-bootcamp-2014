...
1. Modify the GAMs of earnings fit to smooth functions of height and education to set `k` to a variety of values and see how the estimated relationships change.
